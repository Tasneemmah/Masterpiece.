    ...
    <div className="flex flex-row h-full w-full overflow-x-hidden">
      <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
        <div className="flex flex-row items-center justify-center h-12 w-full">
          ...
          <div className="ml-2 font-bold text-2xl">صندوق البريد</div>
        </div>
        ...
        <div className="flex flex-col mt-8">
          <div className="flex flex-row items-center justify-between text-xs">
            <span className="font-bold">المحادثات النشطة</span>
        ...
        <div className="flex flex-col flex-auto flex-shrink-0 rounded-2xl bg-gray-100 h-full p-4">
          ...
          <div className="flex flex-row items-center h-16 rounded-xl bg-white w-full px-4">
            ...
            <div className="ml-4">
              ...
              <button onClick={()=>handleSendMessage()} className="flex items-center justify-center bg-cyan-500 hover:bg-indigo-600 rounded-xl text-white px-4 py-1 flex-shrink-0">
                <span>ارسال</span>
                <span className="ml-2">
                  <svg
