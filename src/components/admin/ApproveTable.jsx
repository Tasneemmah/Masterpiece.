       ...
       const handleDelete = (id,name,userid) => {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
              ...
              Swal.fire(` ${name}تمت الإزالة  `, '', 'success');
...
<form>
  ...
  <div className="relative">
    ...
    <button
      ...
      type="submit"
      className="text-white bg-cyan-700 absolute right-2.5 bottom-2.5 amber-600 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
    >
      إضافة بريد إلكتروني
    </button>
  </div>
      ...
      <thead>
        <tr role="row">
          ...
          <th
            ...
            style={{ cursor: "pointer" }}
          >
            <p className="text-xs tracking-wide text-gray-600">رقم الهاتف</p>
          </th>
          <th
            colSpan={1}
            role="columnheader"
            ...
            style={{ cursor: "pointer" }}
          >
            <p className="text-xs tracking-wide text-gray-600">الموقع</p>
          </th>
