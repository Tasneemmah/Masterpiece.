        ...
        <div class="max-w-screen-xl m-0 sm:m-20 bg-white shadow sm:rounded-lg flex justify-center flex-1">
          ...
          <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12 sm:w-10/12">
            ...
            <div class="mt-12 flex flex-col items-center ">
              <h1 class="text-2xl xl:text-3xl font-extrabold text-cyan-700 ">
              سجل للانضمام إلينا!
              </h1>
              <div class="w-full flex-1 mt-8">
                <div class="flex flex-col items-center">
                  <button
                    className="bg-cyan-100 p-2 rounded-lg text-black hover:text-black hover:bg-cyan-500"
                    onClick={() => login()}
                  >
                    الاشتراك مع جوجل
                    <svg
                ...
                <form onSubmit={handleSubmit}>
                  <div class="mx-auto max-w-xs">
                    ...
                    <div class="mb-3">
                      ...
                      يجب أن تحتوي كلمة المرور على 8 أحرف على الأقل بما في ذلك رقم وحرف خاص
                        </p>
                      )}
                    </div>
                    <div>
