      ...
      <div class="max-w-screen-xl m-0 sm:m-20 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        ...
        <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12 sm:w-10/12">
          ...
          <div class="mt-12 flex flex-col items-center">
            <h1
              class="text-2xl xl:text-3xl font-extrabold text-cyan-700 "
            ...
            <div class="w-full flex-1 mt-8">
              ...
              <form onSubmit={handleSubmit}>
                <div class="mx-auto max-w-xs">
                  ...
                  <button
                    type="submit"
                    class="mt-5 tracking-wide font-semibold bg-cyan-500 text-black w-full py-4 rounded-lg hover:text-white hover:bg-cyan-600 transition-bg duration-500 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
                  >
                    {/* <svg
                      class="w-6 h-6 -ml-2"
                      fill="none"
                  ...
                  <p className={`mt-2 text-sm text-600 dark:text-500`}>
                    ...
                    <p className={`mt-2 text-sm text-cyan-700 dark:text-500`}>
                    ليس لديك حساب !{" "}
                      <Link
                        to="/signUp"
