...
function PaymentPage() {
  ...
  const handlePayment = () => {
    if (localStorage.auth != null && localStorage.auth != "") {
      ...
      if (!cardRegex.test(cardNumber)) {
        showAlert("رقم البطاقة غير صالح");
        return;
      }
      ...
      if (
        ...
        showAlert("انتهت صلاحية البطاقة");
        return;
      }
  ...
  const showSuccessAlert = () => {
    Swal.fire({
      title: "شكرا لك على الحجز من خلال موقعنا على الإنترنت",
      icon: "success",
        ...
        <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12 sm:w-10/12">
          <div>
            <div className="mt-12 flex flex-col items-center">
              <h1 className="text-2xl xl:text-3xl font-extrabold text-cyan-700">
              صفحة الدفع
              </h1>
              <div className="w-full flex-1 mt-8">
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                  ...
                  أكمل حجزك من خلال تقديم تفاصيل الدفع الخاصة بك.
                  </p>
                ...
                <div className="mt-6 border-t border-b py-2">
                  <div className="flex items-center justify-between">
                    ...
                    <p className="font-semibold text-gray-900">40.00 JOD</p>
                  </div>
                  <div className="mt-6 flex justify-between">
                    <Link to="/Details/2" className="text-sm text-cyan-700">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
