  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage:
            'url("https://img.freepik.com/free-photo/close-up-executive-making-phone-call_1098-3256.jpg?t=st=1687882918~exp=1687883518~hmac=954d822aa56c79c371711c9ab93649891246734a5623a3045678b21de76e15ac")',
          height: "400px",
        }}
      >
              ...
              <div className="w-full  lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0" style={{ marginRight: "60px", marginLeft: "65px" }}>
                  ...
                  <h4 className="text-body-color mb-9 text-base leading-relaxed">
                    إذا كان لديك أسئلة أو تشعر بالارتباك بشأن شيء ما
                    لا تتردد وتواصل معنا الآن نحن هنا من أجلك
                  </h4>
                ...
                <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                  <form method="post" onSubmit={handleSubmit}>
                    ...
                    <div>
                      <button
                        type="submit"
                        className="bg-cyan-700 border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                      >
                        ارسل رسالة
                      </button>
                    </div>
