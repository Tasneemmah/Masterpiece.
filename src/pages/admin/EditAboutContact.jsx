...
// };
  ...
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
    ...
    <div>
              <label for="subject" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">من نحن العنوان</label>
              <input type="text" id="subject" class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="أدخل هنا العنوان ل من نحن" required 
               value={about_title}
      ...
      <div className="sm:col-span-2">
        ...
        <textarea
          ...
          placeholder="أدخل هنا من نحن الوصف ......."
          defaultValue={""}
          value={about_us}
